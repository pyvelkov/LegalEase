...
(
    ...
    CONSTRAINT user_templates_pkey PRIMARY KEY (tmp_uuid)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.user_templates
    OWNER to postgres;

COMMENT ON TABLE public.user_templates
    IS 'Stores all user template records';